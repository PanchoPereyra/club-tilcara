  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundImage: "url('/img/imagenes-generales/pelota2.jpeg')"
      ...
      <div class="relative z-10 w-full h-full p-6 flex flex-col justify-between items-end">
        ...
        <div class="flex flex-col items-end text-white text-right space-y-2">
          ...
          {/* <div class="p-3 rounded-full shadow-lg">
            <img 
              src="/img/imagenes-generales/Escudo-Tilcara-Texto-Blanco.png" // LOGO DEL CLUB
              alt="Logo Club Tilcara" 
              class="h-27 w-auto" // REGULAR ALTURA DESPUES CON LA IMAGEN
            />
          ...
          <div className="flex flex-col items-end text-white space-y-2">
            ...
            {/* Este es el contenedor que debe centrar el escudo y el texto */}
            <div className="flex flex-col items-center p-3">
              <img
                src="/img/imagenes-generales/Escudo-Tilcara-Texto-Blanco.png"
                alt="Logo Club Tilcara"
                className="h-24 w-auto mb-2" // Ajusté un poco la altura y agregué margen inferior
              />
              <p className="text-sm font-medium text-center">Rugby | Hockey</p>
            </div>
            </div>
